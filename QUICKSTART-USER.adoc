...
// Replace phronesiser, Phronesiser — See README.adoc for details., just run, Phronesiser started successfully. with actuals
= phronesiser — Quick Start for Users
:toc:
:toclevels: 2

== What is phronesiser?

Phronesiser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./phronesiser-portable
----
...
[source]
----
Phronesiser started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/phronesiser/wiki
