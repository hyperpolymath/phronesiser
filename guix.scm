...
;;
;; Guix package definition for Phronesiser
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace Phronesiser and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/Phronesiser")
