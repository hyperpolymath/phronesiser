...
//
// phronesiser CLI — Add provably safe ethical constraints to AI agent decision-making via Phronesis
...
#[derive(Subcommand)]
enum Commands {
    /// Initialise a new phronesiser.toml manifest.
    Init { #[arg(short, long, default_value = ".")] path: String },
    /// Validate a phronesiser.toml manifest.
    Validate { #[arg(short, long, default_value = "phronesiser.toml")] manifest: String },
    /// Generate Phronesis wrapper, Zig FFI bridge, and C headers.
    Generate {
        #[arg(short, long, default_value = "phronesiser.toml")] manifest: String,
        #[arg(short, long, default_value = "generated/phronesiser")] output: String,
    },
    /// Build the generated artifacts.
    Build { #[arg(short, long, default_value = "phronesiser.toml")] manifest: String, #[arg(long)] release: bool },
    /// Run the workload.
    Run {
        #[arg(short, long, default_value = "phronesiser.toml")] manifest: String,
    ...
    Info { #[arg(short, long, default_value = "phronesiser.toml")] manifest: String },
}
